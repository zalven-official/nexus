...
<template>
  <form
    ...
    <div class="relative h-full w-full items-center justify-center rounded-sm bg-background py-2 px-4">
      <div :class="`absolute inset-0 bg-gradient-to-l from-${color}-500 from-1% opacity-50 z-0`" />
              ...
              <p class="z-10 flex items-center">
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <div class="w-64 p-4">
                        <a class="text-sm font-semibold" :href="link" target="_blank"> {{ title }} </a>
